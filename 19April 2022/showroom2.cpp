...
int main()
{
    ...
    ifstream ifs;
    ifs.open("carList.txt");
    
    for(int i=1; i<=3; i++)
    {
        carDeets cd;
        ifs>>cd.varientName>>cd.price>>cd.color>>cd.engType;
        cout<<"List  "<<i <<":"<<endl<<"Name:\t\t"<<cd.varientName<<endl;
        cout<<"Price:\t\t"<<cd.price<<endl;
        cout<<"Color:\t\t"<<cd.color<<endl;
        cout<<"EngineType:\t"<<cd.engType<<endl<<endl;
    }
